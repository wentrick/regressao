...
#### Estime com 95% de confiança Y para X1 = 25, X2 = 35 e X3 = 20. 

Vamos calcular o intervalo de confiança para uma observação, dentro do limite dos dados, com esses parametros:
```{r}
...
#### Estime com 95% de confiança Y para X1 = 35, X2 = 35 e X3 = 20. 

Vamos repetir o calculo porem o X1 está maior do que o limite dos dados (o X1 vai ate 31)
```{r}
...
#### Estime com 95% de confiança 4 novas observações para Y para X1 = 27, X2 = 32 e X3 = 24. 

Vamos agira calcular o IC para m novas observações:
